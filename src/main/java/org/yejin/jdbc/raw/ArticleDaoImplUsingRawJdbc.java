...
public class ArticleDaoImplUsingRawJdbc implements ArticleDao {
	...
	//static final String URL = "jdbc:mariadb://localhost:3306/yejindb?username=yejin&password=yejin";
	//static final String GET_ARTICLE = "select articleId, title, content, userId, name, cdate from article where articleId=1";
